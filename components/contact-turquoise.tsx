                ...
                <CardContent className="p-6">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-500">+34 628840747</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  ...
                  <Input
                    ...
                    required
                    className="border-teal-100 focus-visible:ring-teal-600"
                  />
                </div>
                <div>
                ...
                <div>
                  ...
                  <Textarea
                    ...
                    required
                    className="min-h-[120px] border-teal-100 focus-visible:ring-teal-600"
                  />
                </div>
